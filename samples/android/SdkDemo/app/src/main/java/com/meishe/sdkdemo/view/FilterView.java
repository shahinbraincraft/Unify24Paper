...
public class FilterView extends RelativeLayout {
    ...
    public void setBlackTheme(boolean is) {
        ...
        if (mCommonFilterTab != null) {
            mCommonFilterTab.setTextColor(ContextCompat.getColor(MSApplication.getContext(), is ? R.color.ccffffff : R.color.black));
        }
        if (mMoreFilerText != null) {
            mMoreFilerText.setTextColor(ContextCompat.getColor(MSApplication.getContext(),  is ? R.color.ccffffff : R.color.black));
        }
        if (mFilterAdapter != null) {
            mFilterAdapter.setBlackTheme(is);
        }
    }
    ...
    private void selectFilterTab(boolean isCartoon) {
        if (isCartoon) {
            mCartoonFilterTab.setTextColor(ContextCompat.getColor(MSApplication.getContext(), R.color.ms_blue));
            mCommonFilterTab.setTextColor(ContextCompat.getColor(MSApplication.getContext(), isBlackTheme ? R.color.ccffffff : R.color.black));
            ...
            mCartoonFilterTab.setTextColor(ContextCompat.getColor(MSApplication.getContext(), isBlackTheme ? R.color.ccffffff : R.color.black));
            mCommonFilterTab.setTextColor(ContextCompat.getColor(MSApplication.getContext(), R.color.ms_blue));
