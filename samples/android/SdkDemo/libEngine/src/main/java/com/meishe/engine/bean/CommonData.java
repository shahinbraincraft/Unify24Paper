...
public class CommonData {
    ...
    public static final long MIN_SHOW_LENGTH_DURATION = (long) (CommonData.TIMEBASE * 0.8);    //最小的展示duration
    ...
    public static final String TYPE_BUILD_IN = "builtin";//内置特效
    public static final String TYPE_PACKAGE = "package";//包特效
    public static final String TYPE_PROPERTY = "property";//属性特技
    public static final String TYPE_RAW_BUILTIN = "rawBuiltin";//原始内置特效


    public static final String SUB_TYPE_CROPPER_TRANSFORM = "cropper_transform";//裁剪transform
    public static final String SUB_TYPE_CROPPER = "cropper";//裁剪
    public static final String SUB_TYPE_MASK = "mask";

    public final static int EFFECT_BUILTIN = 0;//內建特效
    public final static int EFFECT_PACKAGE = 1;//包特效

    public static final int MAX_AUDIO_COUNT = 16;
    //这块默认设置为4K,
    // 因为添加了一个compile页面可以动态修改分辨率，
    // 如果创建比分辨率timeline 选择更高的分辨率 无法生成对应的分辨率
