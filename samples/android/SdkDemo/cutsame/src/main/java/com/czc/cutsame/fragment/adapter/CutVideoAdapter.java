...
public class CutVideoAdapter extends BaseQuickAdapter<NvsAssetPackageManager.NvsTemplateFootageCorrespondingClipInfo, BaseViewHolder> {
    ...
    private void setBackGroundImage(ImageView imageView, NvsAssetPackageManager.NvsTemplateFootageCorrespondingClipInfo item) {
        NvsVideoClip nvsVideoClip = EditorController.getInstance().getVideoClipByIndex(item.trackIndex, item.clipIndex);
    ...
    protected void convert(
            @NonNull BaseViewHolder helper, NvsAssetPackageManager.NvsTemplateFootageCorrespondingClipInfo item) {
