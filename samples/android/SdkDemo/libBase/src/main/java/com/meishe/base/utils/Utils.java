...
public final class Utils {
     ...
     * @return file 文件
     */
    public static File uri2File(@NonNull final Uri uri,Context context) {
        File file = uri2FileReal(uri,context);
        if (file != null) {
            return file;
        }
    ...
    private static File uri2FileReal(@NonNull final Uri uri,Context context) {
        ...
        if (ContentResolver.SCHEME_FILE.equals(scheme)) {
            ...
            if ("com.android.externalstorage.documents".equals(authority)) {
                ...
                if ("primary".equalsIgnoreCase(type)) {
                    if(AndroidOS.USE_SCOPED_STORAGE){
                        return new File(context.getExternalFilesDir("") + "/" + split[1]);
                    }else{
    ...
    private static File getFileFromUri(final Uri uri,
        ...
        if ("com.google.android.apps.photos.content".equals(uri.getAuthority())) {
            ...
            if (!TextUtils.isEmpty(path)) {
                ...
                if(AndroidOS.USE_SCOPED_STORAGE){
                    fileDir = getApp().getExternalFilesDir("");
                }
