...
public class StoryboardUtil {
     ...
     * <effect name="transform">
     * <param name="scaleX" value="1.00000"/>
     * <param name="scaleY" value="1.00000"/>
     * <param name="rotationZ" value="-0.00000"/>
     * <param name="transX" value="0.00000"/>
     * <param name="transY" value="-0.00000"/>
     * </effect>
     * </textTrack>
     * </storyboard>
     *
     * @return
     */
    public static String getMaskTextStoryboard(int width, int height, int textHeight, String text,
                                               long clipDuration, float scaleX, float scaleY, float transX,
                                               float transY, float rotation) {
        String capText = text.replaceAll("\n","&#10;");
        return "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                "<storyboard sceneWidth=\"" + width + "\" sceneHeight=\"" + height + "\">\n" +
                "    <textTrack height=\"" + textHeight + "\" bold=\"1\" posterTimeHint=\"0\" " +
                "clipStart=\"0\" source=\"" + capText + "\" clipDuration=\"" + clipDuration + "\">\n" +
                "        <effect name=\"transform\">\n" +
