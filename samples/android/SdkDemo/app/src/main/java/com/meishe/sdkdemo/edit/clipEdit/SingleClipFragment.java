...
public class SingleClipFragment extends Fragment {
    ...
    private VideoFragmentSeekListener mVideoFragmentSeekListener;
    ...
    /**
     * 播放器进度seek回调 目前是变速页面使用
     */
    public interface VideoFragmentSeekListener{
        void onSeekBarChanged(long timeStamp);
    }
                    ...
                    switch (event.getAction()) {
                        ...
                        case MotionEvent.ACTION_MOVE: {
                            ...
                            if (mMakeRatio == NvAsset.AspectRatio_16v9
                                    ...
                                    || mMakeRatio == NvAsset.AspectRatio_18v9
                                    || mMakeRatio == NvAsset.AspectRatio_21v9) {
                                maxValue = mLiveWindow.getLayoutParams().height / 2;
                                    ...
                                    || mMakeRatio == NvAsset.AspectRatio_9v18
                                    || mMakeRatio == NvAsset.AspectRatio_9v21) {
    ...
    public void setVideoFragmentSeekListener(VideoFragmentSeekListener videoFragmentSeekListener){
        this.mVideoFragmentSeekListener = videoFragmentSeekListener;
    }
    ...
    public void seekTimeline(long timestamp, int seekShowMode) {
         ...
         * param3: 图像预览模式Imag；e preview mode
    ...
    private void controllerOperation() {
        mPlayButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                /*
                 * 判断当前引擎状态是否是播放状态
                 * Determine if the current engine state is playing
                 * */
        ...
        mPlaySeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                if (fromUser) {
                    ...
                    if(null != mVideoFragmentSeekListener){
                        mVideoFragmentSeekListener.onSeekBarChanged(progress * BASE_VALUE);
                    }
                }
            }
