...
//                }
    ...
    private void refreshVideoView() {
        ...
        //0.7的屏宽和getLimitLength 0.7 screen size and getLimitLength
        ...
        //频繁刷新这部分非常耗时，放在子线去吧 , 现在看来还是不行，view的数据源大的时候，还是有问题，
        //解决这个问题的方法应该是不去刷新数据源，直接修改mNvsMultiThumbnailSequenceView 的宽度  参考剪映
