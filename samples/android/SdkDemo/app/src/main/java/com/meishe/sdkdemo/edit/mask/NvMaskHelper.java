...
public class NvMaskHelper {
     ...
     *
     * @param maskWidth
     * @param center             mask中心点
     * @param centerCircleRadius 中心圆的半径
     * @param angle              旋转角度
     * @return 线性mask 点集合
     */
    ...
    /// - Parameters:
    ///   - center: mask中心点
    ///   - rotation: 旋转角度  这里传的是0  不用考虑了
    ///    roundCornerWidthRate 圆角比例
    /// - Returns: 线性mask 点集合
    /// 默认在中间
    @SuppressLint("NewApi")
...
//        //Log.e(TAG,"X = "+newX +"  Y ="+newX +"  angle="+angle);
     ...
     * @param center           中心点坐标
     * @param width            椭圆长半轴 对应的屏幕比例 屏幕宽度为
     * @param height           椭圆短半轴 对应的屏幕比例
     * @param angle            旋转角度
     * @param cornerRadiusRate 圆角比例
     * @return
     */
