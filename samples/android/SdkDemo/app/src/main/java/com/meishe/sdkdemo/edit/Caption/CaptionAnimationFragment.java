 ...
 * @Description :视频编辑-字幕-动画-Activity
 * @Description :VideoEdit-Caption-animation-Activity
...
public class CaptionAnimationFragment extends Fragment {
     ...
     * It is detected that the animated tab is displayed as required,
     * and only the first initialization will be used
     * */
    ...
    /***
     * 展示动画Tab对应的内容
     * Show the content corresponding to the animation Tab
     */
    ...
    public HorizontalSeekBar getSeekBar() {
        return mSeekBar;
    }
}
