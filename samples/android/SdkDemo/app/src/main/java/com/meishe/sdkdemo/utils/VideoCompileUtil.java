...
public class VideoCompileUtil {
    ...
    public static void compileVideo(NvsStreamingContext context,
        ...
        if (customHeight != -1) {
            ...
            context.compileTimeline(timeline, startTime, endTime, compileVideoPath,
                    NvsStreamingContext.COMPILE_VIDEO_RESOLUTION_GRADE_CUSTOM, NvsStreamingContext.COMPILE_BITRATE_GRADE_HIGH, encoderFlag|NvsStreamingContext.STREAMING_ENGINE_COMPILE_FLAG_BUDDY_HOST_VIDEO_FRAME);
        } else {
            context.compileTimeline(timeline, startTime, endTime, compileVideoPath,
                    videoResolutionGrade, NvsStreamingContext.COMPILE_BITRATE_GRADE_HIGH, encoderFlag|NvsStreamingContext.STREAMING_ENGINE_COMPILE_FLAG_BUDDY_HOST_VIDEO_FRAME);
        }
    }
    ...
    public static void compileVideo(NvsStreamingContext context,
                                    ...
                                    long startTime,
                                    long endTime) {
        compileVideo(context, timeline, compileVideoPath, startTime, endTime, NvsStreamingContext.COMPILE_VIDEO_RESOLUTION_GRADE_CUSTOM, timeline.getVideoRes().imageHeight);
    }
