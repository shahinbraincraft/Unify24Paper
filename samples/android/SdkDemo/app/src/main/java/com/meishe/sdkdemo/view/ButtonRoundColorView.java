...
public class ButtonRoundColorView extends View {
    ...
    public ButtonRoundColorView(Context context) {
        super(context);
    }

    public ButtonRoundColorView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
