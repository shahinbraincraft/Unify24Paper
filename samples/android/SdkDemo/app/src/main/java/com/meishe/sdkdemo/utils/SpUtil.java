...
public class SpUtil {
    ...
    private SpUtil(Context context) {
        if (sp == null) {
            sp = context.getSharedPreferences("default_ms", Context.MODE_PRIVATE);
        }
    }
    ...
    public boolean setObjectToShare(Context context, Object object, String key) {
        ...
        * Convert object to byte array and base64 encode it
        * */
        ...
        * Write the encoded string to the base64.xml file
        * */
        ...
        try {
            ...
            * */
            if (wordBase64 == null || wordBase64.equals("")) {
                ...
                * Indispensable, otherwise java.io.StreamCorruptedException will be reported below
                * */
                return null;
            }
            ...
            /*
            * 将byte数组转换成product对象
            * Convert byte array into product object
            * */
