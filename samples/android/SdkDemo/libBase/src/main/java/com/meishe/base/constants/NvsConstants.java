...
public class NvsConstants {
    ...
    public final static String KEY_BACKGROUND_ROTATION = "Enable Background Rotation";                 //背景旋转
    public final static String KEY_BACKGROUND_MUTLISAMPLE = "Enable MutliSample";                 //背景，锯齿
    public final static String PROPERTY_OPACITY = "Opacity"; // 透明度
