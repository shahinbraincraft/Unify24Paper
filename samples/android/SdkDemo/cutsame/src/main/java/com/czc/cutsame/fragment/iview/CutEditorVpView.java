...
public interface CutEditorVpView extends IBaseView {
    ...
    void getCaptionBitmap(long inPoint, Bitmap bitmap);

    void getVideoData(List<NvsAssetPackageManager.NvsTemplateFootageCorrespondingClipInfo> templateClipList);
