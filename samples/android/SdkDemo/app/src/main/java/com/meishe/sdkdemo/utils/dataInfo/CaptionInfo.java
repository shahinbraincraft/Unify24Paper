...
public class CaptionInfo {
     ...
     * Subtitle color
     * */
    private float captionBackgroundPadding;
   ...
   /*
     * 使用下划线标识
     * Use underline identification
     * */
    private int m_usedUnderlineFlag = ATTRIBUTE_UNUSED_FLAG;
    /*
     * 使用颜色标识
     ...
     * Use background identification
     * */
    private int mUsedBackgroundPaddingFlag = ATTRIBUTE_UNUSED_FLAG;
    /*
     * 使用描边标识
     * Use stroke logo
     * */
    ...
    private List<NvsCaptionSpan> mList=new ArrayList<>();
    ...
    public int getUsedUnderlineFlag() {
        return m_usedUnderlineFlag;
    }

    public void setUsedUnderlineFlag(int underlineFlag) {
        this.m_usedUnderlineFlag = underlineFlag;
    }
    ...
    public int getUsedBackgroundPaddingFlag() {
        return mUsedBackgroundPaddingFlag;
    }

    public void setUsedBackgroundPaddingFlag(int usedBackgroundPaddingFlag) {
        this.mUsedBackgroundPaddingFlag = usedBackgroundPaddingFlag;
    }

    public float getCaptionBackgroundPadding() {
        return captionBackgroundPadding;
    }

    public void setCaptionBackgroundPadding(float captionBackgroundPadding) {
        this.captionBackgroundPadding = captionBackgroundPadding;
    }

    public void setList(List<NvsCaptionSpan> list) {
        this.mList = list;
    }

    public List<NvsCaptionSpan> getList() {
        return mList;
    }
    ...
    public CaptionInfo clone() {
        ...
        newCaptionInfo.setCaptionBackgroundPadding(this.getCaptionBackgroundPadding());
        ...
        newCaptionInfo.setUnderline(this.isUnderline());
        newCaptionInfo.setList(this.mList);
//        newCaptionInfo.setCaptionSize(this.getCaptionSize());
        ...
        newCaptionInfo.setUsedBackgroundPaddingFlag(this.getUsedBackgroundPaddingFlag());
        newCaptionInfo.setUsedUnderlineFlag(this.getUsedUnderlineFlag());
