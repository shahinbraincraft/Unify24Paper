...
public class CuttingMenuView extends RelativeLayout implements View.OnClickListener {
    ...
    private int[] ratioString = new int[]{R.string.free,
            R.string.nineTSixteen, R.string.threeTFour, R.string.nineTEighteen,
            R.string.nineTTwentyOne,
            R.string.oneTone, R.string.sixteenTNine, R.string.fourTThree};

    private int[] ratioIcon = new int[]{R.drawable.cutting_free_bg,
            R.drawable.cutting_nine_sixteen, R.drawable.cutting_three_four,
            R.drawable.cutting_nine_eighteen, R.drawable.cutting_nine_21,
            R.drawable.cutting_one_tone, R.drawable.cutting_sixteen_nine, R.drawable.cutting_four_three};

    private int[] ratios = new int[]{NvsConstants.AspectRatio.AspectRatio_NoFitRatio,
            NvsConstants.AspectRatio.AspectRatio_9v16, NvsConstants.AspectRatio.AspectRatio_3v4,
            NvsConstants.AspectRatio.AspectRatio_9v18, NvsConstants.AspectRatio.AspectRatio_9v21,
            NvsConstants.AspectRatio.AspectRatio_1v1, NvsConstants.AspectRatio.AspectRatio_16v9,
