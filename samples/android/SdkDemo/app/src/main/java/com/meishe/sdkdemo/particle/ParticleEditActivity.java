...
public class ParticleEditActivity extends BaseActivity {
    ...
    private final int FRAME_RATION = 30;
    ...
    * */
    ...
    protected void initListener() {
        ...
        mSaveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                * stop is an asynchronous operation, so 500ms is delayed here
                * */
                ...
                switch (motionEvent.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        * */
                        ...
                        /*
                        * 开始刷新粒子特效
                        * Start refreshing particle effects
                        * */
                        startParticleTimer();
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        * */
                        ...
                        /*
                        * 停止刷新粒子特效
                        * Stop refreshing particle effects
                        * */
                        stopParticleTimer();
    ...
    private void updateFilterDataList(){
        ...
        if (SystemUtils.isZh(getApplicationContext())) {
            noneAsset.name = "无";
        } else {
            noneAsset.name = "no";
        }
    ...
    private void searchLocalFilterData(){
        ...
        /*
        * 查找本地粒子滤镜文件
        * Find local particle filter files
        * */
    ...
    private void assetDataRequest(){
        mAssetManager.downloadRemoteAssetsInfo(mAssetType, -1,NvAsset.AspectRatio_All, NvAsset.NV_CATEGORY_ID_PARTICLE_TOUCH_TYPE,1, 100);
    ...
    /*
    * 获取粒子滤镜数据列表
    * Get particle filter data list
    * */
    private ArrayList<NvAsset> getAssetsDataList(){
        return mAssetManager.getRemoteAssets(mAssetType, NvAsset.AspectRatio_All, NvAsset.NV_CATEGORY_ID_PARTICLE_TOUCH_TYPE);
    }
    ...
    private void initRecyclerView() {
        ...
        /*
        * 查询粒子触摸滤镜
        * Querying Particle Touch Filters
        * */
    ...
    * RecyclerView to initialize particle effects
    * */
        ...
        mParticalFilterAdapter.setOnItemClickListener(new ParticleFilterAdapter.OnItemClickListener() {
            ...
            public void onItemDownload(View view, int position) {
                ...
                if (mAssetDownloadPos > 0 && mCurrentParticlePos == position) {
                    /*
                    * 重复点击，不作处理。防止素材多次下载
                    * Click repeatedly without processing. Prevent multiple downloads of footage
                    * */
                    return;
                }
    ...
    * */
    ...
    /*
    * 初始化TimeLine（全部的视频内容）
    * Initialize TimeLine (full video content)
    * */
    ...
    * When you slide your finger on the player, open the seek timer of the screen
    * */
    ...
    * When the player finishes sliding and raises the finger, it stops the seek timer
    * */
    ...
    /*
    * 更新seekBar上滑块的位置
    * Update the position of the slider on seekBar
    * */
    ...
    * Start drawing mask on SequenceView
    * */
    ...
    * Stop drawing mask on SequenceView
    * */
    private void endDrawSequenceProgress() {
        /*
        * 延迟一下，是因为可能定时器seek画面还没完全结束，导致蒙层有间隙
        * The delay is because the timer seek screen may not be completely over yet, causing gaps in the mask.
        * */
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
