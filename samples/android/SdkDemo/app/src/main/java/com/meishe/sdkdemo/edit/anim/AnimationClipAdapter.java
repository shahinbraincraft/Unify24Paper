 ...
 * @Description :AnimationClipAdapter
 * @Description :AnimationClipAdapter
...
public class AnimationClipAdapter extends RecyclerView.Adapter<AnimationClipAdapter.ViewHolder> {
     ...
     * Set the selected clip on Set the animation, duration and type of animation
     * @param selectedPosition    片段的index
     * @param mAnimationDuration  动画时长
     * @param animationType       动画类型
     */
    public void setAnimationDuration(int selectedPosition , long mAnimationDuration, int animationType) {
