...
public class EditColorPickerView extends RelativeLayout {
    private ButtonRoundColorView mCustomBtn;
    ...
    public EditColorPickerView(Context context) {
        super(context);
    }

    public EditColorPickerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public void setDefaultColor(int[] defaultColor, ColorData colorData) {
    ...
    private void initData(ColorData colorData) {
        initListView(colorData);
    }

    private void initListView(ColorData colorData) {
    ...
    class ListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            viewHolder.colorView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mOnColorChangedListener != null) {
                        mOnColorChangedListener.onColorChanged(new ColorData(-1f, position, mData[position]));
                    }
        ...
        class ViewHolder {
            public ButtonRoundColorView colorView;
        }
    }

    public interface OnColorChangedListener {
        void onColorChanged(ColorData colorData);
    }
