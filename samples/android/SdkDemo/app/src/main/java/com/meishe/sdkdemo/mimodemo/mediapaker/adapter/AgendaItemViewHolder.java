...
import com.meishe.sdkdemo.mimodemo.mediapaker.utils.TimeUtil;
import com.meishe.sdkdemo.utils.FileUtils;

import static com.meishe.sdkdemo.mimodemo.mediapaker.fragment.MediaFragment.GRIDITEMCOUNT;
...
public class AgendaItemViewHolder extends RecyclerView.ViewHolder {
    ...
    private void setImageByFile(String imagePath, Uri thumbPathUri, int width) {
