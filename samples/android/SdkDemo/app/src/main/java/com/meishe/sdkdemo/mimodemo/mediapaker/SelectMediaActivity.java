...
import com.meishe.sdkdemo.mimodemo.MimoEditActivity;
...
import com.meishe.sdkdemo.mimodemo.common.utils.MimoCommonUtil;
...
import static com.meishe.sdkdemo.mimodemo.common.Constants.POINT16V9;
import static com.meishe.sdkdemo.mimodemo.mediapaker.utils.MediaConstant.KEY_CLICK_TYPE;
import static com.meishe.sdkdemo.mimodemo.mediapaker.utils.MediaConstant.LIMIT_COUNT;
    ...
    protected void initViews() {
        ...
        mBottomMenu.setOnNextClickListener(new SelectBottomMenu.OnNextClickListener() {
            ...
            public void onNextClicked() {
                String supportedAspectRatio = MimoTimelineUtil.getSupportedAspectRatio();
...
//        setTotal(0);
    ...
    private void selectCreateRatio(int makeRatio) {
        TimelineData.instance().setVideoResolution(MimoCommonUtil.getVideoEditResolution(makeRatio));
        TimelineData.instance().setMakeRatio(makeRatio);
//        MiMoInfo templateInfo = NvMiMoContext.getInstance().getSelectTemplate();
    ...
    private void goNextActivity() {
        Intent intent = new Intent(SelectMediaActivity.this, MimoEditActivity.class);
        if (mOperateCode > 0) {
    ...
    private void convertVideo() {
        ...
        String contverVideoDir = MimoPathUtils.getVideoConvertDirPath();
