...
import com.meishe.sdkdemo.showToast
import com.meishe.sdkdemo.utils.*
import com.meishe.sdkdemo.utils.dataInfo.ClipInfo
import com.meishe.sdkdemo.utils.dataInfo.TimelineData
import kotlinx.android.synthetic.main.activity_quick_splicing.*
    ...
    override fun initListener() {
        ...
        mStreamingContext.setCompileCallback(object : NvsStreamingContext.CompileCallback {
            ...
            override fun onCompileFinished(p0: NvsTimeline?) {
                ...
                showToast("导出视频成功：$mCompileVideoPath")
            }

            override fun onCompileFailed(p0: NvsTimeline?) {
                changeProgressBarVisible(View.GONE)
                showToast("导出视频失败：Video profile or level are different")
            }
        })
