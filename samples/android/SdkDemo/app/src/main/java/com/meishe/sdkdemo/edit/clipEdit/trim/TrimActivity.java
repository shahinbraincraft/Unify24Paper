 ...
 * @Description :视频编辑-编辑-裁剪时长-Activity
 * @Description :VideoEdit-edit-trim-Activity
...
public class TrimActivity extends BaseActivity {
    ...
    /*
    * mFromActivity值是EditActivity表示即从EditActivity页面进入裁剪页面,
    * 值是PictureInPictureActivity，即从画中画页面进入裁剪页面
    *
    * The mFromActivity value is the value of EditActivity, that is, the edit page is entered from the EditActivity page,
    *The value is PictureInPictureActivity, that is, from the picture-in-picture page to the cropped page
    */
