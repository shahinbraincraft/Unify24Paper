 ...
 * @Description :闪光特效Activity。GlitterEffectActivity
...
public class GlitterEffectActivity extends BaseActivity implements GlitterEffectInterface {
    ...
    private boolean startRecord() {
       ...
       // mRecordFilePath = PathUtils.getFlashEffectRecordingDirectory( );
        String fileName ="glitterEffect"+System.currentTimeMillis()+".mp4";
        mRecordFilePath = com.meishe.engine.util.PathUtils.getVideoSavePath(fileName);
