...
public final class BarUtils {
     ...
     * @param isVisible True to set status bar visible, false otherwise. True设置状态栏可见，否则设置为false。
     */
     ...
     * 设置状态栏的灯光模式
     * @param activity    The activity.
     * @param isLightMode True to set status bar light mode, false otherwise. 设置状态栏灯光模式为True，设置为false
     */
     ...
     * 设置状态栏的颜色
     * @param activity The activity.
     * @param color    The status bar's color. 状态栏的颜色
     */
    ...
    public static void setStatusBarColor(@NonNull final View fakeStatusBar,
        ...
        Activity activity = Utils.getActivityByContext(fakeStatusBar.getContext());
        if (activity == null) {
            return;
        }
        transparentStatusBar(activity);
     ...
     * 设置自定义状态栏
     * @param fakeStatusBar The fake status bar view. 虚假的状态栏视图
     */
     ...
     * 设置通知栏的可见性
     * @param isVisible True to set notification bar visible, false otherwise. True设置通知栏可见，false设置不可见
     */
    ...
    public interface OnNavigationStateListener{
       void onNavigationState(boolean isShowing, int narHeight);
    }
}