...
public class GrallyScaleHelper {
    ...
    /*
    * 最少的子控件个数
    * Minimum number of child controls
    * */
    private int minChild;
    /*
    * 最多的子控件个数
    * Maximum number of child controls
    * */
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                * */
                if (dx != 0) {
                    /*
                    * 去掉奇怪的内存疯涨问题
                    * Get rid of strange memory spikes
                    * */
    ...
    public void onBindViewHolder(View itemView, final int position, int itemCount, ImageView imageView) {
        float mPagePadding = (ScreenUtils.getScreenWidth(MSApplication.getContext()) - ScreenUtils.dip2px(MSApplication.getContext(), 212)) / 2;
