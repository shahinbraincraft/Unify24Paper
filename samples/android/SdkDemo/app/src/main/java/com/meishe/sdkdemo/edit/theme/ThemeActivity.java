 ...
 * @Description :视频编辑-主题-Activity
 * @Description :VideoEdit-Theme-Activity
...
public class ThemeActivity extends BaseActivity {
    ...
    private void initThemeViewList() {
        ...
        mThemeAdapter.setOnItemClickListener(new ThemeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                 ...
                 * */
                ArrayList<CaptionInfo> captionArray = TimelineData.instance().getCaptionData();
                TimelineUtil.setCaption(mTimeline, captionArray,themeClipDuration);
                /*
                 * 播放视频
                 * Play video
                 * */
    ...
    /**
     * 是否含有主题开头字幕
     * Whether to include the title opening caption
     */
