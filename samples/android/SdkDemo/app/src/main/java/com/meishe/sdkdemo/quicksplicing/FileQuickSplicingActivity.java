...
import static com.meishe.sdkdemo.TopLevelFunKt.showToast;
...
public class FileQuickSplicingActivity extends BaseActivity {
    ...
    protected void initTitle() {
        ...
        mTitleBar.setOnTitleBarClickListener(new OnTitleBarClickListener() {
            ...
            public void OnRightTextClick() {
                ...
                nvsPassthroughConvertor.convertMediaFile(mClipInfo.getFilePath(), compileVideoPath,
                        mClipInfo.getTrimIn(), mClipInfo.getTrimOut(), null);
    ...
    class FilePassThroughConvertorCallback implements NvsPassthroughConvertor.PassthroughConvertorCallback {
        ...
        @Override
        public void onFinish(long l, String s, String s1, long l1, long l2, int i) {
            MediaScannerUtil.scanFile(s1, "video/mp4");
            showToast("导出视频成功:" + s1);
        }
    }
