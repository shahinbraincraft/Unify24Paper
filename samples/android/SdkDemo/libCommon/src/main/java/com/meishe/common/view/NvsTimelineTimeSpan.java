package com.meishe.common.view;
...
import com.meishe.common.bean.KeyFrameInfo;
import com.meishe.logic.R;
...
public class NvsTimelineTimeSpan extends RelativeLayout {
     ...
     * @param rightThumb
     */
    public void changeTimeSpan(boolean rightThumb, int second) {
        //todo
        int dxSpace = new Double(second * 1000 * 1000f * mPixelPerMicrosecond).intValue();
        if (!rightThumb) {
            left(dxSpace);
            LayoutParams lp = (LayoutParams) getLayoutParams();
            lp.width = originRight - originLeft;
