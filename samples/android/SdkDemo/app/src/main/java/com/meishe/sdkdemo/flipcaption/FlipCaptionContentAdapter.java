 ...
 * @Description :翻转字幕 文字内容Adapter
 * @Description :FlipCaption CaptionContextAdapter
 * @Copyright :www.meishesdk.com Inc.All rights reserved.
 */
public class FlipCaptionContentAdapter extends RecyclerView.Adapter<FlipCaptionContentAdapter.ViewHolder>  {
    ...
    public FlipCaptionContentAdapter(Context context) {
        mContext = context;
    }
