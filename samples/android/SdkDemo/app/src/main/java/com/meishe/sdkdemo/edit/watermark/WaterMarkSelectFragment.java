 ...
 * @Description :视频编辑-水印-选择-Fragment
 * @Description :VideoEdit-WaterMark-select-Fragment
...
public class WaterMarkSelectFragment extends BaseFragment {
    ...
    protected void initListener() {
        ...
        recyclerWatermark.setAdapter(homeAdapter);
    }
        ...
        public void onBindViewHolder(final MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {//view获取和赋
            ...
            holder.imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    onItemClickListener.onItemClick(holder, position, imageList.get(position).getItemPictureType(), picturePath, type, waterMarkPicturePath);
                }
            });
        }
