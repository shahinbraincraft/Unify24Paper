...
public class NvAsset {
    ...
    public static final int ASSET_CHANGE_SPEED_CURVE = 27;                             //曲线变速
    public static final int ASSET_ANIMATED_STICKER_IN_ANIMATION = 28;//贴纸进动画
    public static final int ASSET_ANIMATED_STICKER_OUT_ANIMATION = 29;//贴纸出动画
    public static final int ASSET_ANIMATED_STICKER_ANIMATION = 30;//贴纸组合动画
    public static final int ASSET_MAKEUP = 31;//美妆
    public static final int ASSET_MAKEUP_WARP = 33;//美妆
    public static final int ASSET_MAKEUP_FACE = 34;//美妆
    public static final int ASSET_FILTER_DOU = 32;//抖视频滤镜
    ...
    public int getPackageType() {
        if (assetType == NvAsset.ASSET_THEME) {
            ...
            return NvsAssetPackageManager.ASSET_PACKAGE_TYPE_VIDEOFX;
        } else if (assetType == NvAsset.ASSET_MAKEUP) {
            return NvsAssetPackageManager.ASSET_PACKAGE_TYPE_MAKEUP;
        }else if (assetType == NvAsset.ASSET_MAKEUP_FACE) {
            return NvsAssetPackageManager.ASSET_PACKAGE_TYPE_FACE_MESH;
        }else if (assetType == NvAsset.ASSET_MAKEUP_WARP) {
