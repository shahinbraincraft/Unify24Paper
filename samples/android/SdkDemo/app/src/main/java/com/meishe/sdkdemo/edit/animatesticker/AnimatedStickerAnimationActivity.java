 ...
 */
public class AnimatedStickerAnimationActivity extends BaseActivity {
    private final String TAG = "StickerAnimal";
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.sticker_style_finish:
    ...
    private void initAssetData() {
        ...
        TimelineUtil.setSticker(mTimeline, mStickerInfoListClone);
        selectSticker();
    }
    ...
    private void selectSticker() {
        ...
        List<NvsTimelineAnimatedSticker> animatedStickers = mTimeline.getAnimatedStickersByTimelinePosition(curPos);
