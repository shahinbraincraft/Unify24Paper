...
public class ImageLoader {
    ...
    public static class Options {
        ...
        /**
         * 圆角图片
         * ImageView的大小远小于原始图片的大小的情况下使用
         */
        public Options roundedCornersSmall(int roundingRadius) {
            requestOptions.transform(new RoundedCornersSmall(roundingRadius));
            return this;
        }
    ...
    public static class RoundedCornersSmall extends BitmapTransformation {
        ...
        public RoundedCornersSmall(int roundingRadius) {
