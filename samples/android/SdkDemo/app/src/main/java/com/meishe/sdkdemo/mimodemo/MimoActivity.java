...
public class MimoActivity extends BaseActivity {
    ...
    protected void initData() {
        ...
        //拿到保存本地的文件路径  /storage/emulated/0/Android/data/com.meishe.ms240sdkdemo/files/NvStreamingSdk/Asset/mimo/
        mDownloadPath = PathUtils.getAssetDownloadPath(com.meishe.sdkdemo.utils.asset.NvAsset.ASSET_MIMO) + File.separator;
        installFont();
