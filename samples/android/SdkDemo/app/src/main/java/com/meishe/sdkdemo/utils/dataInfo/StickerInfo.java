...
//    }
    ...
    private long periodAnimationDuration;//周期动画周期时长
    private long outAnimationDuration;//出动画时长
    private long inAnimationDuration;//进动画时长
    private String periodAnimationId;//周期动画id
    private String inAnimationId;//进动画
    private String outAnimationId;//出动画

    public long getPeriodAnimationDuration() {
        return periodAnimationDuration;
    }

    public void setPeriodAnimationDuration(long periodAnimationDuration) {
        this.periodAnimationDuration = periodAnimationDuration;
    }
    ...
    public void setInAnimationDuration(long inAnimationDuration) {
        this.inAnimationDuration = inAnimationDuration;
    }

    public String getPeriodAnimationId() {
        return periodAnimationId;
    }

    public void setPeriodAnimationId(String periodAnimationId) {
        this.periodAnimationId = periodAnimationId;
    }

    public String getInAnimationId() {
        return inAnimationId;
    }

    public void setInAnimationId(String inAnimationId) {
        this.inAnimationId = inAnimationId;
    }

    public String getOutAnimationId() {
        return outAnimationId;
    }

    public void setOutAnimationId(String outAnimationId) {
