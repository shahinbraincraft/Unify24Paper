...
import com.meishe.fxplugin.MediaSelectActivity;
import com.meishe.fxplugin.R;
import com.meishe.fxplugin.adapter.AgendaSimpleSectionAdapter;
import com.meishe.fxplugin.adapter.GridSpacingItemDecoration;
import com.meishe.fxplugin.adapter.SectionedSpanSizeLookup;
import com.meishe.fxplugin.base.BaseFragment;
import com.meishe.fxplugin.data.MediaData;
import com.meishe.fxplugin.interfaces.OnTotalNumChange;
...
import com.meishe.fxplugin.utils.MediaUtils;
    ...
    * */
    ...
    protected void initArguments(Bundle arguments) {
        if (arguments != null) {
            ...
            clickType = arguments.getInt(KEY_CLICK_TYPE, MediaConstant.TYPE_ITEMCLICK_MULTIPLE);
        }
    }
    ...
    public void refreshSelect(List<MediaData> listOfOther, int from) {
        if (index != 0) {
            if (mActivity instanceof MediaSelectActivity){
                MediaSelectActivity activity = (MediaSelectActivity) mActivity;
